...
INSERT INTO `challenges` (`id`, `name`, `start_location`, `target_location`, `distance`, `start_date`, `end_date`, `creator_id`, `team_id`, `created_at`, `updated_at`, `state`, `is_deleted`) VALUES
	(1, 'Graz-Wien', 'Graz', 'Wien', 200, '2025-07-31 00:00:00.000', '2025-08-30 23:59:00.000', 1, 1, '2025-07-31 09:36:43.290', '2025-07-31 09:36:43.290', 'geplant', 0),
	...
	(25, 'Britney Spears', 'Liverpool', 'London', 10000000, '2025-11-04 09:34:00.000', '2222-12-22 22:22:00.000', 1, 1, '2025-11-04 09:36:25.339', '2025-11-04 09:36:25.000', 'laufend', 0),
...
-- Exportiere Daten aus Tabelle step_together_api.challenge_team: ~13 rows (ungefähr)
DELETE FROM `challenge_team`;
INSERT INTO `challenge_team` (`challenge_id`, `team_id`, `created_at`) VALUES
	(1, 1, '2025-11-12 07:09:30'),
	(1, 2, '2025-11-12 07:09:30'),
...
-- Exportiere Daten aus Tabelle step_together_api.teams: ~28 rows (ungefähr)
DELETE FROM `teams`;
INSERT INTO `teams` (`id`, `name`, `creator_id`, `created_at`, `updated_at`, `is_deleted`) VALUES
	...
	(27, 't', 1, '2025-11-03 14:10:18.034', '2025-11-03 14:12:59.669', 1),
	(28, 'exemple team', 1, '2025-11-03 14:55:06.966', '2025-11-03 14:56:14.641', 1),
	(29, 's', 1, '2025-11-04 10:05:05.308', '2025-11-04 10:05:43.191', 1),
	(30, 'Sophie Weber', 1, '2025-11-04 10:05:36.026', '2025-11-04 10:05:41.040', 1);
...
INSERT INTO `users` (`id`, `name`, `email`, `hashed_password`, `step_length`, `is_active`, `is_verified`, `verification_token`, `password_reset_token`, `failed_login_attempts`, `locked_until`, `created_at`, `updated_at`, `is_deleted`, `role`, `public_profile`) VALUES
	(1, 'AliceUp CuperUp', 'alice@example.com', '$2b$12$vN6B/84ztylEhOGB/5VICeD6UFHFwT2NOXT9wZKLKDbbU0GCXME1O', 0.95, 1, 0, NULL, NULL, 0, NULL, '2025-07-31 10:15:53.953', '2025-11-06 10:21:58.249', 0, 'admin', 1),
	(2, 'Bob', 'bob@example.com', '$2y$10$iH.9U3Tx60HWwV51V7WfXezj21A06jBrtSyIlRwcXSJ7HXtI7Qzjy', 10, 1, 0, NULL, NULL, 0, NULL, '2025-07-31 10:15:53.953', '2025-11-06 09:49:01.442', 0, 'user', 1),
	(3, 'Charlie Brown', 'charlie@example.com', '$2b$12$vN6B/84ztylEhOGB/5VICeD6UFHFwT2NOXT9wZKLKDbbU0GCXME1O', 0.8, 1, 0, NULL, NULL, 0, NULL, '2025-07-31 10:15:53.953', '2025-11-03 10:27:05.097', 0, 'user', 1),
	...
	(98, 'Nadine Hartwig', 'nadine.hartwig@example.com', '$2b$12$vN6B/84ztylEhOGB/5VICeD6UFHFwT2NOXT9wZKLKDbbU0GCXME1O', 0.87, 1, 1, NULL, NULL, 0, NULL, '2025-07-31 10:15:53.957', '2025-11-03 10:27:05.097', 0, 'user', 1),
	(99, 'Oliver Bauer', 'oliver.bauer@example.com', '$2b$12$vN6B/84ztylEhOGB/5VICeD6UFHFwT2NOXT9wZKLKDbbU0GCXME1O', 0.72, 1, 0, NULL, NULL, 0, NULL, '2025-07-31 10:15:53.957', '2025-11-03 10:27:05.097', 0, 'user', 1),
	(100, 'Petra Koch', 'petra.koch@example.com', '$2b$12$vN6B/84ztylEhOGB/5VICeD6UFHFwT2NOXT9wZKLKDbbU0GCXME1O', 0.84, 1, 1, NULL, NULL, 0, NULL, '2025-07-31 10:15:53.957', '2025-11-03 10:27:05.097', 0, 'user', 1),
	(147, 'Britney Spears', 'britney111@example.com', '$2b$12$KN9dKnPsyC9pc/T4ZnfVNOXlBqWNcmHN.oXKBobSme9109o6qlRDS', 0.75, 1, 0, NULL, NULL, 0, NULL, '2025-08-06 11:09:54.794', '2025-11-03 10:27:05.097', 0, 'user', 1),
	(148, 'Britney Spears', 'britney1112@example.com', '$2b$12$ugXJdW5dbLebtZrDIItYGehX.7AlBPE9xKAf.7x4vReT1gYLfbI9.', 0.75, 1, 0, NULL, NULL, 0, NULL, '2025-08-06 11:10:08.842', '2025-11-03 10:27:05.097', 0, 'user', 1),
	(149, 'Britney Spears', 'britney1211@example.com', '$2b$12$lJt8/KETGuYxRk1LhtSB4eHcZ5LQNGhyKRhdTHIXR.9m.Ops6gTTG', 0.75, 1, 0, NULL, NULL, 0, NULL, '2025-08-07 07:28:38.852', '2025-11-03 10:27:05.097', 0, 'user', 1),
	(173, 'test', 'test@test.com', '$2y$10$5cqwrIQ2mUi98V6dTv9Oy.lA7vAt3xbmN9h5p4eKHMEwj0OPrzc1i', 12, 1, 0, NULL, NULL, 0, NULL, '2025-10-23 00:00:00.000', '2025-11-03 10:27:05.097', 0, 'user', 1),
	(174, 'Sophie Weber', 'testuse123r@test.com', '$2y$10$WXXLmyqGhaVPHpHsVpMrF.tLQ5cf/7I98ns0HrBsIQ2uzxlyqrsTC', 12, 1, 0, NULL, NULL, 0, NULL, '2025-11-04 10:06:47.663', '2025-11-04 10:06:47.663', 0, 'admin', NULL),
