...
-- Exportiere Daten aus Tabelle step_together.challenges: ~3 rows (ungefähr)
...
-- Exportiere Daten aus Tabelle step_together.teams: ~3 rows (ungefähr)
DELETE FROM `teams`;
...
-- Exportiere Daten aus Tabelle step_together.users: ~6 rows (ungefähr)
DELETE FROM `users`;
