...
-- Exportiere Datenbank-Struktur für step_together
DROP DATABASE IF EXISTS `step_together`;
CREATE DATABASE IF NOT EXISTS `step_together` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */;
USE `step_together`;

-- Exportiere Struktur von Tabelle step_together.challenges
...
-- Exportiere Daten aus Tabelle step_together.challenges: ~2 rows (ungefähr)
...
-- Exportiere Struktur von Tabelle step_together.challenge_progress
...
-- Exportiere Daten aus Tabelle step_together.challenge_progress: ~6 rows (ungefähr)
...
-- Exportiere Struktur von Tabelle step_together.challenge_progresses
...
-- Exportiere Daten aus Tabelle step_together.challenge_progresses: ~0 rows (ungefähr)
DELETE FROM `challenge_progresses`;

-- Exportiere Struktur von Tabelle step_together.schritt_logs
...
-- Exportiere Daten aus Tabelle step_together.schritt_logs: ~6 rows (ungefähr)
...
-- Exportiere Struktur von Tabelle step_together.teams
...
-- Exportiere Daten aus Tabelle step_together.teams: ~2 rows (ungefähr)
DELETE FROM `teams`;
...
-- Exportiere Struktur von Tabelle step_together.team_members
...
-- Exportiere Struktur von Tabelle step_together.users
-- Updated table structure with security features
...
-- Updated sample data with security fields
INSERT INTO `users` (
  `id`, `name`, `email`, `hashed_password`, `schrittlaenge`, 
  `is_active`, `is_verified`, `created_at`, `updated_at`
) VALUES
  (1, 'Alice Cooper', 'alice@example.com', '$2b$10$ZLO18CSbJhmDGM/xT15BEe9zjUg11FU.sFgfbqfpN/7IIQARUl.Ya', 0.8, 1, 1, '2025-06-02 06:29:26.525', '2025-06-02 06:29:26.525'),
  (2, 'Bob Smith', 'bob@example.com', '$2b$10$ZLO18CSbJhmDGM/xT15BEe9zjUg11FU.sFgfbqfpN/7IIQARUl.Ya', 0.75, 1, 1, '2025-05-14 11:44:47.624', '2025-05-14 11:44:47.624'),
  (3, 'Charlie Brown', 'charlie@example.com', '$2b$10$ZLO18CSbJhmDGM/xT15BEe9zjUg11FU.sFgfbqfpN/7IIQARUl.Ya', 0.8, 1, 0, '2025-05-14 11:44:47.624', '2025-05-14 11:44:47.624'),
  (10, 'David Miller', 'david@example.com', '$2b$10$ZLO18CSbJhmDGM/xT15BEe9zjUg11FU.sFgfbqfpN/7IIQARUl.Ya', 0.85, 1, 0, '2025-05-27 09:17:34.053', '2025-05-27 09:17:34.053'),
  (11, 'Eva Johnson', 'eva@example.com', '$2b$10$ZLO18CSbJhmDGM/xT15BEe9zjUg11FU.sFgfbqfpN/7IIQARUl.Ya', 0.85, 1, 1, '2025-05-27 09:50:11.845', '2025-05-27 09:50:11.845'),
  (12, 'Leonie Schmidt', 'leonie@bfi.at', '$2b$10$ZLO18CSbJhmDGM/xT15BEe9zjUg11FU.sFgfbqfpN/7IIQARUl.Ya', 0.8, 1, 1, '2025-06-02 06:31:21.612', '2025-06-02 06:31:21.612');
