        ...
        >
          <View style={styles.navContent}>
            ...
            <View style={styles.navTextContainer}>
              ...
              <Text style={styles.navSubText}>Profil & persönliche Daten</Text>
            </View>
          </View>
          <MaterialIcons name="chevron-right" size={22} style={styles.chevron} />
        </Pressable>
        ...
        >
          <View style={styles.navContent}>
            ...
            <View style={styles.navTextContainer}>
              ...
              <Text style={styles.navSubText}>Passwort & Sicherheit</Text>
            </View>
          </View>
          <MaterialIcons name="chevron-right" size={22} style={styles.chevron} />
        </Pressable>
        ...
        >
          <View style={styles.navContent}>
            ...
            <View style={styles.navTextContainer}>
              ...
              <Text style={styles.navSubText}>Account dauerhaft entfernen</Text>
            </View>
          </View>
          <MaterialIcons name="chevron-right" size={22} style={styles.chevron} />
        </Pressable>
...
const styles = StyleSheet.create({
  container: { flex: 1, backgroundColor: '#f2f7f2ff' },
  ...
  navRowPressed: { backgroundColor: '#eef5ee' },
  ...
  navIcon: { color: '#2f5c3a' },
  navTextContainer: { flex: 1 },
  navText: { fontSize: 16, fontWeight: '600', color: '#111', marginBottom: 2 },
  navSubText: { fontSize: 13, color: '#666' },
  chevron: { color: '#999', marginLeft: 8 },
});
