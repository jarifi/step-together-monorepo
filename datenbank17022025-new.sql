...
-- Exportiere Daten aus Tabelle step_together_api.challenges: ~22 rows (ungefähr)
...
INSERT INTO `challenges` (`id`, `name`, `start_location`, `target_location`, `distance`, `start_date`, `end_date`, `creator_id`, `team_id`, `created_at`, `updated_at`, `is_deleted`) VALUES
	(1, 'Graz-Wien', 'Graz', 'Wien', 200, '2025-07-31 00:00:00.000', '2025-12-31 23:59:00.000', 1, 1, '2025-07-31 09:36:43.290', '2025-07-31 09:36:43.290', 0),
...
-- Exportiere Daten aus Tabelle step_together_api.refresh_tokens: ~23 rows (ungefähr)
